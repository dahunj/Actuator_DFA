...
public:
	...
	void Set_LotDataCopy(int nFmPNo, int nToPNo);
	...
	void Set_LoadPickerOpenMulti(int nPickNo, int nSub, int nCnt);
	...
	BOOL Get_LoadPickerOpenMulti(int nPickNo, int nSub, int nCnt);
