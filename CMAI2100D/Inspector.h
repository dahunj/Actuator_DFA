...
private:
	...
	void Get_InspectComplete(int nInspector, CString sType, CString sLotID, CString sPortNo, CString sTrayNo, CString sCMNo, CString sJudge, CString sNGCode, CString sImageCnt1, CString sImageCnt2, CString sMarginal, CString sNGCodeVision, CString sRcvData);
	...
	void Get_RecipeBody(int nInspector, CString sType, CString sRcvData);
...
public:
	...
	void Set_ModuleData(int nInspector, CString sLotID, int nNo, CString sModuleID, CString sSite, CString sEqpID, CString sEqpName, CString sPara, CString sToolC, int nCount);

	int	 Get_VisionStatus(int nInspector);
	BOOL Check_LotReady();
	void Set_LotReady(BOOL bSetValue);
	...
	void Set_InspectRequest(int nInspector, CString sType, CString sLotID, int nPortNo, int nTrayNo, int nCMNo);
	void Set_RecipeRequest(int nType, CString sLotID, CString sRcpID);

	void Test_Command(int nInspector, CString sType, CString sRcvData);
};
